...
onready var softCollision = $ally_collision
...
func _physics_process(delta):
	...
	# Stick to collision without pushing
	# Stick to collision without pushing
	if softCollision.is_colliding():
		velocity = Vector2.ZERO  # Stick by stopping movement on collision
		
		# Play the idle animation based on the last direction faced
